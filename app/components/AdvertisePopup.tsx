  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" role="dialog" aria-modal="true">
      ...
      <div className="relative z-10 w-full max-w-lg rounded-2xl border border-white/15 bg-[#101522] p-5 sm:max-w-xl sm:p-8 shadow-2xl">
        <button 
          onClick={onClose} 
          aria-label="Close advertising popup"
        ...
        <span className="inline-block rounded-md border border-[#00D2FF]/30 bg-[#00D2FF]/10 px-3 py-1 text-xs font-bold tracking-wide text-[#00D2FF]">
        ...
        <div className="mt-5 relative">
          ...
          <button 
            ...
            className="absolute left-2 top-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full border border-white/15 bg-black/50 text-white transition hover:bg-[#00D2FF] hover:text-black"
          >
            ‹
          </button>
          <button 
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full border border-white/15 bg-black/50 text-white transition hover:bg-[#00D2FF] hover:text-black"
          >
            ›
          </button>
          ...
          <div className="mt-3 flex justify-center gap-2">
            {slides.map((_, index) => (
              <button 
                ...
                className={`h-2 rounded-full transition-all ${currentIndex === index ? "w-6 bg-[#00D2FF]" : "w-2 bg-white/20"}`} 
              />
            ))}
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-3 border-t border-white/10 pt-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link href="/contact" onClick={onClose} className="rounded-xl bg-[#00D2FF] px-5 py-3 text-center text-xs font-bold uppercase tracking-wide text-black transition hover:opacity-90">
            Advertise With Us ↗
          </Link>
        </div>
      </div>
