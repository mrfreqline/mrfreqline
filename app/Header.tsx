      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[--background]/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-7 md:flex">
            ...
            <Link href="/resources/best-free-websites" className="text-sm font-medium text-white/80 transition hover:text-[--accent-cyan]">Websites</Link>
            <Link href="/resources/essentials-toolkit" className="text-sm font-medium text-white/80 transition hover:text-[--accent-cyan]">Toolkit</Link>
              ...
              <div className="absolute left-1/2 top-full -translate-x-1/2 pt-3 z-50">
                <div className="flex gap-3 rounded-2xl border border-white/10 bg-[#0d111a] p-3 shadow-xl">
                  <a href="https://kick.com/mrfreqline" target="_blank" rel="noopener noreferrer" aria-label="Kick" className="flex h-10 w-10 items-center justify-center rounded-full bg-[#53FC18]/15 transition hover:bg-[#53FC18]/25">
                    <svg className="h-5 w-5 text-[#53FC18]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 2h6v5h2V5h2V3h2v4h2V3h2v4h2v2h-2v2h2v6h-2v2h-2v2h-2v-2h-2v2H8v-4H6v-2H4v-2H2v2H0V2h2zm4 9h2v2H6v-2z"/></svg>
                  </a>
                  <a href="https://www.instagram.com/mrfreqline" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-10 w-10 items-center justify-center rounded-full bg-pink-500/15 transition hover:bg-pink-500/25">
                    <svg className="h-5 w-5 text-pink-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2c2.72 0 3.06.01 4.12.06 1.06.05 1.79.22 2.43.47.66.26 1.22.6 1.77 1.15.55.55.89 1.11 1.15 1.77.25.64.42 1.37.47 2.43.05 1.06.06 1.4.06 4.12s-.01 3.06-.06 4.12c-.05 1.06-.22 1.79-.47 2.43a4.92 4.92 0 0 1-1.15 1.77 4.92 4.92 0 0 1-1.77 1.15c-.64.25-1.37.42-2.43.47-1.06.05-1.4.06-4.12.06s-3.06-.01-4.12-.06c-1.06-.05-1.79-.22-2.43-.47a4.92 4.92 0 0 1-1.77-1.15 4.92 4.92 0 0 1-1.15-1.77c-.25-.64-.42-1.37-.47-2.43C2.01 15.06 2 14.72 2 12s.01-3.06.06-4.12c.05-1.06.22-1.79.47-2.43.26-.66.6-1.22 1.15-1.77A4.92 4.92 0 0 1 5.45.53C6.09.28 6.82.11 7.88.06 8.94.01 9.28 0 12 0zm0 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 8.25A3.25 3.25 0 1 1 12 6.75a3.25 3.25 0 0 1 0 6.5zM17.5 4.5a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4z"/></svg>
                  </a>
                  ...
                  <a href="https://www.facebook.com/@mrfreqline" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-500/15 transition hover:bg-blue-500/25">
                    <svg className="h-5 w-5 text-blue-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M22 12a10 10 0 1 0-11.56 9.88v-6.99H7.9V12h2.54V9.8c0-2.5 1.49-3.89 3.78-3.89 1.1 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.89h-2.34v6.99A10 10 0 0 0 22 12z"/></svg>
                  </a>
                </div>
              </div>
            </details>
        ...
        {mobileOpen && (
          <div className="border-t border-white/10 bg-[--background] px-6 py-4 md:hidden">
            <nav className="flex flex-col gap-1">
              ...
              <Link href="/resources/best-free-websites" onClick={() => setMobileOpen(false)} className="rounded-lg px-3 py-3 text-sm font-medium text-white/80 transition hover:bg-white/5 hover:text-[--accent-cyan]">Websites</Link>
              <Link href="/resources/essentials-toolkit" onClick={() => setMobileOpen(false)} className="rounded-lg px-3 py-3 text-sm font-medium text-white/80 transition hover:bg-white/5 hover:text-[--accent-cyan]">Toolkit</Link>
