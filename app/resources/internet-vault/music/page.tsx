...
import rawData from "@/data/vault/music.json";
      ...
      <main className="min-h-screen bg-[#07090e] px-6 pt-28 pb-20 font-sans text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <nav className="mb-6 flex items-center gap-2 text-xs text-gray-400">
            ...
            <span>/</span>
            <span className="text-[#00D2FF] font-semibold">Music & Audio</span>
          </nav>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-400 md:text-base">
                Lossless FLAC audio downloads, global internet radio stations, free VST plugins, and production tools.
              </p>
            </div>
          ...
          <div className="mt-8 space-y-4">
            <input
              type="text"
              placeholder="Search artists, downloaders, synths, radio, or plugins..."
              value={searchQuery}
