...
import rawData from "@/data/vault/torrenting.json";
...
export default function VaultTorrentingPage() {
      ...
      <main className="min-h-screen bg-[#07090e] px-6 pt-28 pb-20 font-sans text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <nav className="mb-6 flex items-center gap-2 text-xs text-gray-400">
            ...
            <span>/</span>
            <span className="text-[#00D2FF] font-semibold">Torrenting & P2P</span>
          </nav>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div>
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl">
                Torrenting & P2P Vault
              </h1>
              <p className="mt-2 text-sm text-gray-400 md:text-base">
                Verified public BitTorrent trackers, open-source clients, and high-speed debrid services.
              </p>
            </div>
          ...
          <div className="mt-8 space-y-4">
            <input
              type="text"
              placeholder="Search trackers, clients, debrid, or indexers..."
              value={searchQuery}
