...
import rawData from "@/data/vault/mobile.json";
...
export default function VaultMobilePage() {
      ...
      <main className="min-h-screen bg-[#07090e] px-6 pt-28 pb-20 font-sans text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <nav className="mb-6 flex items-center gap-2 text-xs text-gray-400">
            ...
            <span>/</span>
            <span className="text-[#00D2FF] font-semibold">Mobile Ecosystems</span>
          </nav>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div>
              <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl">
                Mobile Ecosystems Vault
              </h1>
              <p className="mt-2 text-sm text-gray-400 md:text-base">
                F-Droid repositories, clean APK archives, YouTube ReVanced, and permanent iOS sideloading tools.
              </p>
            </div>
          ...
          <div className="mt-8 space-y-4">
            <input
              type="text"
              placeholder="Search APKs, sideloading tools, F-Droid apps, or rootless tweaks..."
              value={searchQuery}
